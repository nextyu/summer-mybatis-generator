 ...
 * @author nextyu
 */
public class ControllerListAllMethodGenerator extends AbstractJavaControllerMethodGenerator {
    private boolean isSimple;

    public ControllerListAllMethodGenerator(boolean isSimple) {
        super();
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        sb.append("List<").append(domainObjectName).append("VO>").append(" ").append(requestMappingObjectName).append("VOS").append(" = ").append(serviceName).append(".").append("listAll(").append("").append(");");
