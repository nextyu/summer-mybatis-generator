...
public class JavaServiceInterfaceGenerator extends AbstractJavaGenerator {
    ...
    private void addSaveMethod(Interface interfaze) {
        AbstractJavaServiceMethodGenerator methodGenerator = new ServiceInterfaceSaveMethodGenerator(false);
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }

    private void addGetByIdMethod(Interface interfaze) {
        AbstractJavaServiceMethodGenerator methodGenerator = new ServiceInterfaceGetByIdMethodGenerator(false);
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }

    private void addUpdateMethod(Interface interfaze) {
        AbstractJavaServiceMethodGenerator methodGenerator = new ServiceInterfaceUpdateMethodGenerator(false);
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }

    private void addListAllMethod(Interface interfaze) {
        AbstractJavaServiceMethodGenerator methodGenerator = new ServiceInterfaceListAllMethodGenerator(false);
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }

    private void addListPageMethod(Interface interfaze) {
        AbstractJavaServiceMethodGenerator methodGenerator = new ServiceInterfaceListPageMethodGenerator(false);
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }

    private void addGetPageInfoMethod(Interface interfaze) {
        AbstractJavaServiceMethodGenerator methodGenerator = new ServiceInterfaceGetPageInfoMethodGenerator(false);
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }
