 ...
 * @author nextyu
 */
public class ServiceInterfaceListAllMethodGenerator extends AbstractJavaServiceMethodGenerator {
    private boolean isSimple;

    public ServiceInterfaceListAllMethodGenerator(boolean isSimple) {
        super();
