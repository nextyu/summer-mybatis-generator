 ...
 * @author nextyu
 */
public class ServiceInterfaceUpdateMethodGenerator extends AbstractJavaServiceMethodGenerator {
    private boolean isSimple;

    public ServiceInterfaceUpdateMethodGenerator(boolean isSimple) {
        super();
