 ...
 * @author nextyu
 */
public class ServiceImplGetPageInfoMethodGenerator extends AbstractJavaControllerMethodGenerator {
    private boolean isSimple;

    public ServiceImplGetPageInfoMethodGenerator(boolean isSimple) {
        super();
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        sb.append("PageHelper.startPage(query.getPageNum(), query.getPageSize());");
        ...
        method.addBodyLine("return new PageInfo<>(" + requestMappingObjectName + "VOS);");
