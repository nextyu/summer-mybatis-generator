 ...
 * @author nextyu
 */
public class ServiceImplListPageMethodGenerator extends AbstractJavaControllerMethodGenerator {
    private boolean isSimple;

    public ServiceImplListPageMethodGenerator(boolean isSimple) {
        super();
