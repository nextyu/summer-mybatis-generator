 ...
 * @author nextyu
 */
public class ServiceImplUpdateMethodGenerator extends AbstractJavaControllerMethodGenerator {
    private boolean isSimple;

    public ServiceImplUpdateMethodGenerator(boolean isSimple) {
        super();
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        sb.append("int rows = ").append(mapperName).append(".").append("updateByPrimaryKeySelective(").append(requestMappingObjectName).append(");");
        method.addBodyLine(sb.toString());
