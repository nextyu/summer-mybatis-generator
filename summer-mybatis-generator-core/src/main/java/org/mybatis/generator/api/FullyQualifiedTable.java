...
public class FullyQualifiedTable {
    ...
    private String requestMappingObjectNameObjectName;
    ...
    public String getRequestMappingObjectName() {
        if (stringHasValue(requestMappingObjectNameObjectName)) {
            return requestMappingObjectNameObjectName;
        } else if (stringHasValue(runtimeTableName)) {
            return getCamelCaseString(runtimeTableName, false);
        } else {
            return getCamelCaseString(introspectedTableName, false);
        }
    }
