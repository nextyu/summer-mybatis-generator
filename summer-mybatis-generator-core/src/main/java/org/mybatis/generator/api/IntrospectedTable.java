...
public abstract class IntrospectedTable {
    ...
    // #############
    public String getBaseVOType() {
        return internalAttributes.get(InternalAttribute.ATTR_VO_TYPE);
    }

    public String getQueryType() {
        return internalAttributes.get(InternalAttribute.ATTR_QUERY_TYPE);
    }
    ...
    private void calculateVOAttributes() {
        StringBuilder sb = new StringBuilder();
        sb.append(Constants.voPackageName);
        sb.append('.');
    ...
    private void calculateQueryAttributes() {
        StringBuilder sb = new StringBuilder();
        sb.append(Constants.queryPackageName);
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Query"); //$NON-NLS-1$

        setQueryType(sb.toString());
    }

    private void calculateControllerAttributes() {
        StringBuilder sb = new StringBuilder();
        sb.append(Constants.controllerPackageName);
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
    ...
    private void calculateServiceAttributes() {
        StringBuilder sb = new StringBuilder();
        sb.append(Constants.servicePackageName);
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
    ...
    private void calculateServiceImplAttributes() {
        StringBuilder sb = new StringBuilder();
        sb.append(Constants.serviceImplPackageName);
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
    ...
    public void setVOType(String voType) {
        internalAttributes.put(
                InternalAttribute.ATTR_VO_TYPE,
                voType);
    }

    public void setQueryType(String queryType) {
        internalAttributes.put(
                InternalAttribute.ATTR_QUERY_TYPE,
                queryType);
    }

    public void setControllerType(String controllerType) {
        internalAttributes.put(
                InternalAttribute.ATTR_CONTROLLER_TYPE,
                controllerType);
    }
